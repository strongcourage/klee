...
MemoryObject * Executor::addExternalObject(ExecutionState &state,
                                           ...
                                           bool isReadOnly) {
    llvm::errs() << "Executor::addExternalObject" << "\n";
...
void Executor::initializeGlobals(ExecutionState &state) {
    llvm::errs() << "Executor::initializeGlobals" << "\n";
...
void Executor::addConstraint(ExecutionState &state, ref<Expr> condition) {
    llvm::errs() << "Executor::addConstraint" << "\n";
...
void Executor::bindLocal(KInstruction *target, ExecutionState &state,
  ...
  llvm::errs() << "Executor::bindLocal" << "\n";
}

void Executor::bindArgument(KFunction *kf, unsigned index,
                            ExecutionState &state, ref<Expr> value) {
    llvm::errs() << "Executor::bindArgument" << "\n";
  getArgumentCell(state, kf, index).value = value;
}

ref<Expr> Executor::toUnique(const ExecutionState &state,
                             ref<Expr> &e) {
    llvm::errs() << "Executor::toUnique" << "\n";
  ref<Expr> result = e;
...
void Executor::executeGetValue(ExecutionState &state,
                               ref<Expr> e,
                               KInstruction *target) {
    llvm::errs() << "Executor::executeGetValue" << "\n";
  e = state.constraints.simplifyExpr(e);
  std::map< ExecutionState*, std::vector<SeedInfo> >::iterator it =
    seedMap.find(&state);
...
void Executor::stepInstruction(ExecutionState &state) {
    llvm::errs() << "Executor::stepInstruction" << "\n";
...
void Executor::executeCall(ExecutionState &state,
    ...
    llvm::errs() << "Executor::executeCall" << "\n";
...
void Executor::transferToBasicBlock(BasicBlock *dst, BasicBlock *src,
    ...
    llvm::errs() << "Executor::transferToBasicBlock" << "\n";
...
Function* Executor::getTargetFunction(Value *calledVal, ExecutionState &state) {
    llvm::errs() << "Executor::getTargetFunction" << "\n";
...
void Executor::executeInstruction(ExecutionState &state, KInstruction *ki) {
    llvm::errs() << "Executor::executeInstruction" << "\n";
  Instruction *i = ki->inst;
  switch (i->getOpcode()) {
    // Control flow
...
void Executor::updateStates(ExecutionState *current) {
    llvm::errs() << "Executor::updateStates" << "\n";
  if (searcher) {
...
void Executor::bindModuleConstants() {
    llvm::errs() << "Executor::bindModuleConstants" << "\n";
...
void Executor::terminateStateEarly(ExecutionState &state,
                                   const Twine &message) {
    llvm::errs() << "Executor::terminateStateEarly" << "\n";
...
void Executor::terminateStateOnError(ExecutionState &state,
    ...
    llvm::errs() << "Executor::terminateStateOnError" << "\n";
...
void Executor::callExternalFunction(ExecutionState &state,
                                    ...
                                    Function *function,
                                    std::vector< ref<Expr> > &arguments) {
    llvm::errs() << "Executor::callExternalFunction" << "\n";
...
void Executor::executeAlloc(ExecutionState &state,
    ...
    llvm::errs() << "Executor::executeAlloc" << "\n";
...
void Executor::executeFree(ExecutionState &state,
                           ref<Expr> address,
                           KInstruction *target) {
    llvm::errs() << "Executor::executeFree" << "\n";
...
void Executor::executeMemoryOperation(ExecutionState &state,
    ...
    llvm::errs() << "Executor::executeMemoryOperation" << "\n";
...
void Executor::executeMakeSymbolic(ExecutionState &state,
                                   const MemoryObject *mo,
                                   const std::string &name) {
    llvm::errs() << "Executor::executeMakeSymbolic" << "\n";
...
void Executor::runFunctionAsMain(Function *f,
				 ...
				 char **argv,
				 char **envp) {
    llvm::errs() << "Executor::runFunctionAsMain" << "\n";
  std::vector<ref<Expr> > arguments;
...
void Executor::doImpliedValueConcretization(ExecutionState &state,
                                            ref<Expr> e,
                                            ref<ConstantExpr> value) {
    llvm::errs() << "Executor::doImpliedValueConcretization" << "\n";
